        ...
        {(parseInt(this.props.monthlyAmount) + parseInt(this.state.currentAmount)) < 5000 ?
          < form action='https://checkout.psigate.com/HTMLPost/HTMLMessenger' method="post" className={styles.form}>
            ...
            {currency === "USD" && (<div className={`${styles.card_wrp} w-100 d-block`}>
              <div className="row">
                <input type="hidden" name="StoreKey" value="DefyGamesUSDDuKewOW021139" />
            ...
            {currency === "USD"
              ? <p className={`${styles.submitbtnlabel} w-100 d-block`}>You will be charged {price} {currency}  by PowerPlay Systems Inc.</p>
              : <p className={`${styles.submitbtnlabel} w-100 d-block`}>{price} {currency}  will be added to your Defy Games Account</p>
            }
